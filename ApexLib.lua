-- [[ APEX ELITE LIBRARY v1.1 - OFFICIAL CONSOLIDATED ]]
-- [[ Desenvolvido por joaorqqq | Otimizado para robloxianos & mobilianos ]]
...
function Apex:CreateWindow(config)
    ...
    self.Title = config.Title or "Apex Elite v1.1"
    ...
    SearchBar.BackgroundColor3 = Color3.fromRGB(18, 18, 18); SearchBar.PlaceholderText = "🔍 Buscar comandos..."
